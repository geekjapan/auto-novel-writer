...
- `show-run-comparison` の minimal valid artifact ケースでは、`best_selection_source`、`best_selection_reason_codes`、`current_comparison_reason_codes`、read-only 性まで tests で固定する
