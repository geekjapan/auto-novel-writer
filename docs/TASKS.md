...
- [ ] M7: Generalize rerun policy and revise flow from chapter 1 to arbitrary chapters while keeping chapter 1 compatibility outputs

## Ready

- [ ] M7: Save per-chapter continuity / rerun / revise histories in manifest
- [ ] M8: Add story-level summary generation across all chapters
- [ ] M8: Add project-wide quality report for theme coherence, POV consistency, foreshadowing coverage, and chapter balance
- [ ] M8: Support multi-run candidate comparison and best-run selection metadata
- [ ] M9: Orchestrate full multi-chapter draft generation from chapter_plan to final revised drafts
- [ ] M9: Add long-run stop conditions and retry policy for multi-chapter generation
- [ ] M9: Add final whole-story pass that generates synopsis, overall quality report, and publish-ready artifact bundle
